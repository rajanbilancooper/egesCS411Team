...
public class MedicationMapper {
    ...
    public static Medication toEntity(MedicationRequest dto) {
        ...
        if (dto.getId() != null) med.setId(dto.getId());
        if (dto.getPatientId() != null) med.setPatientId(dto.getPatientId());
        if (dto.getDoctorId() != null) med.setDoctorId(dto.getDoctorId());
        ...
        med.setOverrideJustification(dto.getOverrideJustification());
        return med;
    }
    ...
    public static MedicationResponse toResponseDto(Medication entity) {
        ...
        dto.setConflictFlag(entity.getConflictFlag());
        dto.setConflictDetails(entity.getConflictDetails());
        dto.setOverrideJustification(entity.getOverrideJustification());
        return dto;
    }
}
